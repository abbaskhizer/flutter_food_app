...
class Food {
  ...
  factory Food.fromMap(Map<String, dynamic> map) {
    ...
    //  dateTime: (map['dateTime'] as Timestamp).toDate(),
     //dateTime: map['dateTime'] != null ? DateTime.fromMillisecondsSinceEpoch(map['dateTime'].toInt()) : null,
     // dateTime: map['dateTime'] != null ? DateTime.fromMillisecondsSinceEpoch(map['dateTime'].toDouble).t : null,
